...
public class ApiTest extends RestHelp {
    ...
    public void getXiaomiCleaner() {
        ...
        Assert.assertEquals((extractJson(response, "positions.primary[1].position_price.amount")), "632.09");
    ...
    public void checkCleanerInCart() {
        ...
        checkStatusCode(response, 200);
        Assert.assertEquals(extractJson(response, "position_groups.positions.total_price.amount[0][0]"), "699.00");
